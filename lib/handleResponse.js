...
module.exports = function createHandler (params) {
  const { reqSet, workDir, mockList, okList, verbose, force, ci, skipQueryParams, queryParams, skipPostParams } = params
  ...
  return function handlerResponse(interceptedResponse) {
    ...
    const fn = storage.name(url, method, postData, workDir, skipQueryParams, queryParams, skipPostParams)
