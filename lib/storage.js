...
const mfn = (url, method = 'GET', postDataArg = '', skipQueryParams = [],  queryParams = [], skipPostParams = [], verbose) => {
...
const getNames = (url, method, postData = '', workDir, skipQueryParams = [], queryParams = [], skipPostParams = [], verbose) => {
  ...
  const fileName = mfn(url, method, postData, skipQueryParams, queryParams, skipPostParams, verbose)
