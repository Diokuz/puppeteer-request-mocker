...
const mfn = (url, method = 'GET', postDataArg = '', queryParams = [], skipQueryParams = [], skipPostParams = [], verbose) => {
...
const getNames = (url, method, postData = '', workDir, queryParams = [], skipQueryParams = [], skipPostParams = [], verbose) => {
  ...
  const fileName = mfn(url, method, postData, queryParams, skipQueryParams, skipPostParams, verbose)
