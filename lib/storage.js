...
const mfn = (url, method = 'GET', headers, postDataArg = '', queryParams = [], skipQueryParams = [], skipPostParams = [], verbose) => {
...
const getNames = (url, method, headers, postData = '', workDir, queryParams = [], skipQueryParams = [], skipPostParams = [], verbose) => {
  ...
  const fileName = mfn(url, method, headers, postData, queryParams, skipQueryParams, skipPostParams, verbose)
